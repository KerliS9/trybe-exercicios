...
const nome = estudantes.find((estudante) => estudante.status < 80);
console.log(`Olá ${nome.nome}, o prazo para entrega do projeto é daqui a 3 dias, vc precisa de alguma ajuda?`)
