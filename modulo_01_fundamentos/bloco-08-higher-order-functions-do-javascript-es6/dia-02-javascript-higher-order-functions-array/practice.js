...
function smallerName() {
  let nameBook;
  books.forEach((book) => {
    if(!nameBook || book.name.length < nameBook.length) { // usado a esclamação no ínicio da variável nameBook, pois a variável não guarda nenhum valor e retorna undefined (falsy). Com a ! converte para truthy.
      nameBook = book.name
    }
  });
...
console.log(decreaseYear(books));
