...
// Com map e filter
const allNameStudentsMap = estudantes.filter((estudante) => (
  estudante.turno === 'Manhã')).map((estudante) => `${estudante.nome} ${estudante.sobrenome}`);
console.log(allNameStudentsMap);
...
console.log(reportStatus('Natalia', estudantes)); // buscando os dados da Natalia
